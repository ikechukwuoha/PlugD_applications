...
class MyManager(BaseUserManager):
    ...
    def create_is_pd_staff(self, email, username, first_name, last_name, password=None, **extra_fields):
        user = self.create_user(email, username, first_name, last_name, password)

        user.is_pd_staff = True
        user.save(using=self._db)
    ...
    def create_superuser(self, email, username, first_name, last_name, password, **extra_fields):
        ...
        extra_fields.setdefault('is_pd_staff', True)
